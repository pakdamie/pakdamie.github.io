...
And if you remembered the mean of the exponential PDF is $1/k$ (We could have found the mean of the CDF, but I just thought it was easier).

That means that the mean time that individuals dwell in A is $1/k$.

Therefore, for example if k = 1/2 per day, then the mean time that an individual stay in A is 1/(1/2) is 2 days.
